...
export const variants = cva("font-regular md:text-sm text-xs", {
  variants: {
    variant: {
      ...
      none: "px-4 py-2 rounded font-medium text-white focus:outline-none transition-all",
      dropdown:
        "px-2 py-1 bg-white hover:bg-gray-100 font-medium text-start transition-all flex flex-row items-center gap-1",
      input:
